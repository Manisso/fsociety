    ...
    ''' + color.END + '''
     ...
     ''')
        ...
        if choice == "1":
            ...
            print(color.OKGREEN + ext + color.END)
            sys.exit()
...
def phishing():
    clearScr()
    os.system("printf '\033]2;fsociety@phishing\a'")
    phishingmenu = """
     888888ba  dP       oo          dP       oo                   
     88    `8b 88                   88                            
     a88aaaa8P'88d888b. dP .d8888b. 88d888b. dP 88d888b. .d8888b. 
     88        88'  `88 88 Y8ooooo. 88'  `88 88 88'  `88 88'  `88 
     88        88    88 88       88 88    88 88 88    88 88.  .88 
     dP        dP    dP dP `88888P' dP    dP dP dP    dP `8888P88 
                                                              .88 
                                                           d8888P  
    """
    print(phishingmenu)
